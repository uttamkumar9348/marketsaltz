                        ...
                        @foreach ($orders as $key => $order_id)
                            ...
                            @if($order != null)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <button type="button" class="btn btn-soft-danger btn-icon btn-circle btn-sm" data-toggle="modal" data-target="#myModalship" title="{{ translate('Ship Now') }}">
                            ...
                            <!-- The Modal -->
<div class="modal" id="myModalship" style="background: #00283fa3; padding-right: 0px!important;">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="{{url('/seller/ship_order_update')}}" method="post" class="col-md-12">
            @csrf
            <div class="row">
            ...
            <div class="form-group col-md-3">
                <label for="exampleInputPassword1">Breadth</label>
                <input type="number" class="form-control" id="" placeholder="Breadth">
            </div>
            <div class="form-group col-md-3">
                <label for="exampleInputPassword1">Height</label>
                <input type="number" class="form-control" id="" placeholder="Height">
            </div>
            <div class="form-group col-md-3">
                <label for="exampleInputPassword1">Weight</label>
                <input type="number" class="form-control" id="" placeholder="Weight">
            </div>
            
            </div>
            <button type="submit" class="btn btn-primary" data-dismiss="" style="float:right;">Submit</button>
        </form>
      </div>
