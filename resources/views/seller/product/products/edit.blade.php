...
<form class="" action="{{route('seller.products.update', $product->id)}}" method="POST" enctype="multipart/form-data"
        ...
        <div class="col-lg-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <select class="form-control aiz-selectpicker" name="category_id" id="category"
                    ...
                    <div id="showdiv">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control req" name="brand_name" placeholder="{{ translate('') }}" value="{{ $product->brand_name }}" onchange="update_sku()" >
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control req" name="hsn_hscode" placeholder="{{ translate('') }}" onchange="update_sku()"  value="{{ $product->hsn_hscode }}">
                            </div>
                        </div>
                    ...
                    <div id="hidediv">
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('CAS NO')}}<span class="text-danger">*</span></label>
                                <div class="col-md-8">
                                <input type="text" class="form-control add_req" name="cas_no" placeholder="{{ translate('0') }}" value="{{ $product->cas_no }}">
                            </div>
                        </div>
                        <div class="form-group row">
                                <label class="col-md-3 col-from-label">{{translate('Purity')}}<span class="text-danger">*</span> </label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control add_req" name="purity" placeholder="{{ translate('0') }}" onchange="update_sku()" value="{{ $product->purity }}">
                                </div>
                            
                            </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-from-label">{{translate('Weight')}}<span class="text-danger">*</span></label>
                            <div class="col-lg-8">
                                @if($product->unit)
                                <input type="text" class="form-control add_req" name="unit"
                                    placeholder="{{ translate('Unit (e.g. KG, Pc etc)') }}"
                                    value="{{$product->unit}}">
                                @else
                                <input type="text" class="form-control add_req" name="volume_weight"
                                    placeholder="{{ translate('Unit (e.g. KG, Pc etc)') }}"
                                    value="{{$product->volume_weight}}">
                                @endif
                            </div>
                        </div>
                    </div>    
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label" for="signinSrEmail">{{translate('Thumbnail Image')}}<span class="text-danger">*</span><small>(290x300)</small></label>
                        <div class="col-md-8">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                <label class="col-lg-3 col-from-label" for="start_date">{{translate('Discount Date Range')}}<span class="text-danger">*</span></label>
                <div class="col-lg-9">
                    <input type="text" class="form-control aiz-date-range" value="{{ $date_range }}" name="date_range" placeholder="{{translate('Select Date')}}" data-time-picker="true" data-format="DD-MM-Y HH:mm:ss" data-separator=" to " autocomplete="off" required>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <textarea class="aiz-text-editor"
                        name="description" required>{{$product->getTranslation('description',$lang)}}</textarea>
                </div>
            </div>
        </div>
    </div>
