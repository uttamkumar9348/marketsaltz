        ...
        <div class="col-lg-8">
                ...
                <div class="card-body">
                    ...
                    <div id="showdiv">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control req" name="brand_name" placeholder="{{ translate('Brand Name') }}" onchange="update_sku()" >
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Model No')}}<span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <input type="text" class="form-control req" name="model_no" placeholder="{{ translate('0') }}" onchange="update_sku()" >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control req" name="hsn_hscode" placeholder="{{ translate('0') }}" onchange="update_sku()" >
                            </div>
                        </div>
                    ...
                    <div id="hidediv">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Purity')}}<span class="text-danger">*</span> </label>
                                <div class="col-md-8">
                                <input type="text" class="form-control add_req" name="purity" placeholder="{{ translate('0') }}" onchange="update_sku()" >
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control add_req" name="unit"
                                    placeholder="{{ translate('Unit (e.g. KG, Pc etc)') }}" onchange="update_sku()">
                            </div>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 control-label" for="start_date">{{translate('Discount Date Range')}}<span class="text-danger">*</span></label>
                        <div class="col-md-9">
        	...
        	$.ajax({
                   ...
                   success : function(data){ // Has to be there !
                     ...
                     if(data[0][0].parent_id == 22 || data[0][0].parent_id == 2){
                        ...
                        $("input[name='cas_no']").val("null");
                        $("input[name='purity']").val("null");
