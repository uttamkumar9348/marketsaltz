...
<div class="row">
    <div class="col-lg-8 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                <form id="add_form" class="form-horizontal" action="{{url('/insert_job')}}" method="POST">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <textarea name="short_desc" rows="5" class="form-control" required=""></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <textarea name="location" rows="5" class="form-control" required=""></textarea>
                        </div>
                    </div>
                    <!--<div class="form-group row">-->
                    <!--    <label class="col-md-3 col-from-label">-->
