...
<div class="">
    <form class="form form-horizontal mar-top" action="{{route('products.insert')}}" method="POST" enctype="multipart/form-data" id="choice_form">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="name" placeholder="{{ translate('') }}" onchange="update_sku()" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate(' Brand Name')}} <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="brand_name" placeholder="{{ translate('') }}" onchange="update_sku()" required>
                            </div>
                        </div>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="number" class="form-control" name="model_no" placeholder="{{ translate('') }}" onchange="update_sku()" required>
                            </div>
                        </div>
                        ...
                        <!--</div>-->
                         ...
                         <div class="form-group row" id="category">
                            <label class="col-md-3 col-from-label">{{translate(' SubCategory')}} <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" name="subcategory" id="category_id" data-live-search="true" required>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="hsn_hscode" placeholder="{{ translate('') }}" onchange="update_sku()" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Country of Origin')}}</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="country_of_origin" placeholder="{{ translate('Country of Origin') }}" required>
                            </div>
                        </div>
                        
                         <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Certifications')}} <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="product_certification" placeholder="{{ translate('Posted on') }}" onchange="update_sku()" required>
                            </div>
                        </div>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="tech_parameters" placeholder="{{ translate('Technical Parameters') }}" onchange="update_sku()" required>
                            </div>
                        </div>
