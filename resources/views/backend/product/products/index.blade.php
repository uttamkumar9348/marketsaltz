            ...
            <table class="table aiz-table mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="row gutters-5 w-200px w-md-300px mw-100 mw_180" style="min-width:180px!important; width:unset!important;">
                                <div class="col-auto">
                                    <img src="{{ uploaded_asset($product->photos)}}" alt="Image" class="size-50px img-fit">
                                </div>
                                <div class="col">
