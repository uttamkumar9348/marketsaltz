            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <!--<div class="form-group row">-->
                        <!--    <label class="col-md-3 col-from-label">{{translate('Unique ID')}} <span class="text-danger">*</span></label>-->
                        <!--    <div class="col-md-8">-->
                        <!--        <input type="text" class="form-control" name="unique_id" placeholder="{{ translate('Unique ID') }}" onchange="update_sku()" >-->
                        <!--    </div>-->
                        <!--</div>-->
                        <div class="form-group row" id="category">
                            <label class="col-md-3 col-from-label">{{translate('Category')}} <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" name="category_id" id="category_getid" data-live-search="true" required>
                    ...
                    <div id="showdiv">
                        <div class="form-group row">
                           <label class="col-md-3 col-from-label">{{translate(' Brand Name')}} <span class="text-danger">*</span></label> 
                            <div class="col-md-8">
                                <input type="text" class="form-control req" name="brand_name" placeholder="{{ translate('') }}" onchange="update_sku()" >
                            </div>
                        </div>
                        <!-- <div class="form-group row" id="brand">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control req" name="model_no" placeholder="{{ translate('') }}" onchange="update_sku()" >
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('HSN / HS Code')}} <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <input type="text" class="form-control req" name="hsn_hscode" placeholder="{{ translate('') }}" onchange="update_sku()" >
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Technical Parameters')}} <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <input type="text" class="form-control req" name="tech_parameters" placeholder="{{ translate('Technical Parameters') }}" onchange="update_sku()" >
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Country of Origin')}} <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <input type="text" class="form-control req" name="country_of_origin" placeholder="{{ translate('Country of Origin') }}" onchange="update_sku()" >
                            </div>
                        </div>
                        ...
                        <!-- <div class="form-group row">-->
                        <!--    <label class="col-md-3 col-from-label">{{translate('Sub Category:')}} <span class="text-danger">*</span></label>-->
                        <!--    <div class="col-md-8">-->
                        <!--        <input type="text" class="form-control" name="sub-category" placeholder="{{ translate('') }}" onchange="update_sku()" >-->
                        <!--    </div>-->
                        <!--</div>-->
                        ...
                        <div id="hidediv">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control add_req" name="cas_no" placeholder="{{ translate('0') }}" onchange="update_sku()" >
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">{{translate('Purity')}} <span class="text-danger">*</span></label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control add_req" name="purity" placeholder="{{ translate('') }}" onchange="update_sku()" >
                                </div>
                            </div>
                        <!-- <div class="form-group row">-->
                        ...
                        <!--</div>-->
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control add_req" name="volume_weight" placeholder="{{ translate('Unit (e.g. KG, Pc etc)') }}" >
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">{{translate('Country of Origin')}} <span class="text-danger">*</span></label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control add_req" name="country_of_origin" placeholder="{{ translate('Country of Origin') }}" onchange="update_sku()" >
                                </div>
                            </div>
                        ...
                        <!-- <div class="form-group row">-->
                        <!--    <label class="col-md-3 col-from-label">{{translate('Posted on')}} <span class="text-danger">*</span></label>-->
                        <!--    <div class="col-md-8">-->
                        <!--        <input type="text" class="form-control" name="posetd-on" placeholder="{{ translate('Posted on') }}" onchange="update_sku()" >-->
                        <!--    </div>-->
                        <!--</div>-->
                        ...
                        <!--    <label class="col-md-3 col-from-label">{{translate('Country of Origin')}} <span class="text-danger">*</span></label>-->
                        <!--    <div class="col-md-8">-->
                        <!--        <input type="text" class="form-control" name="country_of_origin" placeholder="{{ translate('Country of Origin') }}" onchange="update_sku()" >-->
                        <!--    </div>-->
                        <!--</div>-->
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="product_certification" placeholder="{{ translate('Product Certifications') }}" onchange="update_sku()" required>
                            </div>
                        </div>
                        
                        <!-- <div class="form-group row">-->
                        <!--    <label class="col-md-3 col-from-label">{{translate('COA or MSDS')}} <span class="text-danger">*</span></label>-->
                        <!--    <div class="col-md-8">-->
                        <!--        <input type="text" class="form-control" name="coa_msds" placeholder="{{ translate('can be available with the product') }}" onchange="update_sku()" >-->
                        <!--    </div>-->
                        <!--</div>-->
                        ...
                        <!--    <div class="col-md-8">-->
                        <!--        <textarea  class="form-control" name="description" placeholder="{{ translate('') }}" onchange="update_sku()" > </textarea>-->
                        <!--    </div>-->
                        <!--</div>-->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label" for="signinSrEmail">{{translate('Thumbnail Image')}}<span class="text-danger">*</span> <small>(300x300)</small></label>
                            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
	                        <label class="col-sm-3 control-label" for="start_date">{{translate('Discount Date Range')}}<span class="text-danger">*</span></label>
	                        <div class="col-sm-9">
...
<script type="text/javascript">
 ...
 <script type="text/javascript">
    $(document).ready(function () {
        $("#hidediv").show();
        $("#showdiv").hide();
        $("#category_getid").change(function () {
