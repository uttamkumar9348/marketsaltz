        ...
        <div class="row gutters-5">
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" name="category_id" id="category" data-selected="{{ $product->category_id }}" data-live-search="true" required>
                                    @foreach ($categories as $category)
                                    <option value="{{ $category->id }}">{{ $category->getTranslation('name') }}</option>
                                    @foreach ($category->childrenCategories as $childCategory)
                                    @include('categories.child_category', ['child_category' => $childCategory])
                        ...
                        <div id="showdiv">
                            ...
                            <label class="col-lg-3 col-from-label">{{translate('Brand')}} <span class="text-danger">*</span></label>
                                <div class="col-lg-8">
                                    <select class="form-control aiz-selectpicker req" name="brand_id" id="brand_id" >
                            ...
                            <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Model No')}} <span class="text-danger">*</span></label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control req" name="model_no" placeholder="{{ translate('') }}"  value="{{ $product->model_no }}" onchange="update_sku()" >
                                </div>
                            </div>
                            
                            <div class="form-group row">
                                <!--<label class="col-md-3 col-from-label">{{translate('Country of Origin')}} <span class="text-danger">*</span></label>-->
                                <label class="col-md-3 col-from-label">{{translate('Country of Origin')}}<span class="text-danger">*</span></label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control req" name="country_of_origin" placeholder="{{ translate('Country of Origin') }}"  value="{{ $product->country_of_origin }}" onchange="update_sku()" >
                                </div>
                            </div>
                            
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">{{translate('HSN / HS Code')}} <span class="text-danger">*</span></label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control req" name="hsn_hscode" placeholder="{{ translate('') }}"  value="{{ $product->hsn_hscode }}" onchange="update_sku()" >
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">{{translate('Technical Parameters')}}<span class="text-danger">*</span></label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control req" name="tech_parameters" placeholder="{{ translate('Technical Parameters') }}" onchange="update_sku()"  value="{{ $product->tech_parameters }}" >
                                </div>
                            </div>
                        </div>
                        ...
                        <!--<div id="showdiv">-->
                        <!--    <div class="form-group row">-->
                        <!--    <label class="col-md-3 col-from-label">{{translate(' Brand Name')}} <span class="text-danger">*</span></label>-->
                        <!--    <div class="col-md-8">-->
                        <!--        <input type="text" class="form-control" name="brand_name" placeholder="{{ translate('') }}"  value="{{ $product->brand_name }}" onchange="update_sku()">-->
                        <!--    </div>-->
                        <!--</div>-->
                        ...
                        <div id="hidediv">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">{{translate('CAS NO')}}<span class="text-danger">*</span></label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control add_req" value="{{ $product->cas_no }}" name="cas_no" value="{{ $product->purity }}" placeholder="{{ translate('0') }}" onchange="update_sku()" >
                                </div>
                            </div>
                            
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">{{translate('Purity')}}<span class="text-danger">*</span></label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control add_req" name="purity" placeholder="{{ translate('') }}" onchange="update_sku()" value="{{ $product->purity }}" >
                                </div>
                        ...
                        <!--    <div class="col-md-8">-->
                        <!--        <input type="number" class="form-control" name="Price"  placeholder="{{ translate('0') }}" onchange="update_sku()" >-->
                        <!--    </div>-->
                        <!--</div>-->
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">{{translate('Volume/Weight')}}<span class="text-danger">*</span></label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control add_req" name="volume_weight" placeholder="{{ translate('Unit (e.g. KG, Pc etc)') }}"  value="{{ $product->volume_weight }}" >
                                </div>
                            </div>
                           <div class="form-group row">
                                <!--<label class="col-md-3 col-from-label">{{translate('Country of Origin')}} <span class="text-danger">*</span></label>-->
                                <label class="col-md-3 col-from-label">{{translate('Country of Origin')}}<span class="text-danger">*</span></label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control add_req" name="country_of_origin" placeholder="{{ translate('Country of Origin') }}"  value="{{ $product->country_of_origin }}" onchange="update_sku()" >
                                </div>
                            </div>
                             ...
                             <!-- <div class="form-group row"> -->
                                <!--<label class="col-md-3 col-from-label">{{translate('City of Origin')}} <span class="text-danger">*</span></label>-->
                                <!-- <label class="col-md-3 col-from-label">{{translate('City of Origin')}}<span class="text-danger">*</span></label> -->
                                <!-- <div class="col-md-8"> -->
                                    <!-- <input type="text" class="form-control add_req" name="city_of_origin" placeholder="{{ translate('City of Origin') }}"  value="{{ $product->city_of_origin }}" onchange="update_sku()" > -->
                                <!-- </div> -->
                            <!-- </div> -->
                        ...
                        <!--</div>-->
                         ...
                         <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Product Certifications')}}<span class="text-danger">*</span> </label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="product_certification" placeholder="{{ translate('Product Certifications') }}"  value="{{ $product->product_certification }}" onchange="update_sku()">
                            </div>
                        </div>
                        <div class="form-group row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" required  class="form-control aiz-date-range" @if($product->discount_start_date && $product->discount_end_date) value="{{ $start_date.' to '.$end_date }}" @endif name="date_range" placeholder="{{translate('Select Date')}}" data-time-picker="true" data-format="DD-MM-Y HH:mm:ss" data-separator=" to " autocomplete="off">
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-lg-3 col-from-label">{{translate('Description')}}<span class="text-danger">*</span> <i class="las la-language text-danger" title="{{translate('Translatable')}}"></i></label>
                            <div class="col-lg-9">
...
<!--                <div class="card">
            ...
            <div class="col-lg-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <input type="number" name="low_stock_quantity" value="{{ $product->low_stock_quantity }}" min="0" step="1" class="form-control" required>
                        </div>
                    </div>
                </div>
                ...
                <!-- <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Estimate Shipping Time')}}<span class="text-danger">*</span></h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group mb-3">
                            <label for="name">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('VAT & Tax')}}<span class="text-danger">*</span></h5>
                    </div>
                    <div class="card-body">
                        @foreach(\App\Models\Tax::where('tax_status', 1)->get() as $tax)
                        <label for="name">
                            {{$tax->name}}
                            <input type="hidden" value="{{$tax->id}}" name="tax_id[]" required>
                        </label>
...
// machine product
$subcat_id=App\Models\Category::where('parent_id',22)->get();
foreach($subcat_id as $parent){
$id[]=$parent->id;
}

//lab product
$subcat_id=App\Models\Category::where('parent_id',2)->get();
foreach($subcat_id as $parent){
$lab_id[]=$parent->id;
}
...
$(document).ready( function(){
        // $("#hidediv").show();
        // $("#showdiv").hide();
        var arrayFromPHP = <?php echo json_encode($id); ?>;
        var arrayFromPHP_1 = <?php echo json_encode($lab_id); ?>;
        if( $("#category").val() == arrayFromPHP[0] || $("#category").val() == arrayFromPHP[1] || $("#category").val() == arrayFromPHP[2] || $("#category").val() == arrayFromPHP_1[0]){
            $("#showdiv").show();
            $("#hidediv").hide();
        }else{
            $("#hidediv").show();
        ...
        // alert(arrayFromPHP);
        	$.ajax({
                   url : "{{url('/machinary_product')}}", //PHP file to execute
                   ...
                   success : function(data){ // Has to be there !
                     console.log(data[0][0].parent_id);
                     if(data[0][0].parent_id == 22 || data[0][0].parent_id == 2){
                        //  alert('hyy');
                        $("#showdiv").show();
                        $("#hidediv").hide();
                        $(".req").prop('required',true); 
                        $(".add_req").prop('required',false);
                     }
                     else{
                        $("#showdiv").hide();
                        $("#hidediv").show();
                        $(".req").prop('required',false); 
                        $(".add_req").prop('required',true);
                     }
