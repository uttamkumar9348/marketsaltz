<div class="modal fade" id="billing-address-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form class="form-default" role="form" action="{{ url('checkout/billing_addresses') }}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="p-3">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control mb-3" placeholder="{{ translate('Your Name')}}" rows="2" name="name" required></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2">
