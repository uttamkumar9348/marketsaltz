        ...
        <div class="container">
            <div class="bg-white shadow-sm rounded p-3">
                <div class="row">
                    ...
                    <div class="col-xl-7 col-lg-6" style="font-size: 14px;">
                        <div class="text-left">
                            <h1 class="mb-2 fs-20 fw-600">
                                {{ $detailedProduct->getTranslation('name') }}
                            </h1>
                            
                            @if($detailedProduct->cas_no != "null")
                            <p class="mb-0"><b>CAS NO:</b><span class="mr-2 opacity-90"> {{$detailedProduct->cas_no}}</span></p>
                            @endif
                            @if($detailedProduct->model_no != '')
                            <p class="mb-0"><b>Model No:</b><span class="mr-2 opacity-90"> {{$detailedProduct->model_no}}</span></p>
                            @endif
                            @if($detailedProduct->unique_id != '')
                            <p class="mb-0"><b>UNIQUE ID:</b><span class="mr-2 opacity-90" id="unique_id"> {{$detailedProduct->unique_id}}</span></p>
                            @endif
                            ...
                            <div class="row align-items-center">
                                ...
                                <!--    <span class="mr-2 opacity-90">{{ translate('Estimate Shipping Time')}}: </span>{{ $detailedProduct->est_shipping_days }} {{  translate('Days') }}-->
                                <!--</div>-->
                            ...
                            <hr>
                            <div class="pos_rel col-xl-6 col-sm-6 col-12 p-0">
                                @if($detailedProduct->cas_no != 'null')
                                <p class="">Purity:<small class="mr-2"> {{$detailedProduct->purity}}%</small></p>
                                    @if($detailedProduct->volume_weight)
                                        <p class="pos_wgh">Weight:<small class="mr-2"> {{$detailedProduct->volume_weight}}</small></p>
                                    @else
                                        <p class="pos_wgh">Weight:<small class="mr-2"> {{$detailedProduct->unit}}</small></p>
                                    @endif
                                    
                                @else
                                <p class="">Brand Name:<small class="mr-2"> {{$detailedProduct->brand_name}}</small></p>
                                @endif
                            </div>
                            <div class="pos_rel col-xl-6 col-sm-6 col-12"></div>
                            <hr>
                            ...
                            @else
                                @if(home_price($detailedProduct) != home_discounted_price($detailedProduct))
                                    ...
                                    <div class="row no-gutters my-2">
                                        <div class="col-sm-2">
                                            <div class="opacity-90">{{ translate('Pin Code')}}:</div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="row">
                                                <div class="col-sm">
                                                    <input class="form-control" maxlength="6" type="text" placeholder="Pin code" name="pin_code" id="pin_code">
                                                    <snap class="pic_code_error">hyy</snap>
                                                    <snap class="pic_code_error-1 clr">Please enter pin code</snap>
                                                </div>
                                                <div class="col-sm">
                                                    <button class="btn btn-primary" id="check_pin_code">
                                                        Check
                                                    </button>
                                                </div>
                                            </div>
                            ...
                            <form id="option-choice-form">
                                ...
                                @if ($detailedProduct->choice_options != null)
                                    ...
                                    <div class="row no-gutters">
                                        <div class="col-sm-2">
                                            <div class="opacity-90 my-2">{{ \App\Models\Attribute::find($choice->attribute_id)->getTranslation('name') }}:</div>
                                        </div>
                                        <div class="col-sm-10">
                                            <div class="aiz-radio-inline">
                                                <div class="row">
                                                    @foreach ($choice->values as $key => $value)
                                                    <label class="col-sm-2 aiz-megabox pl-0 mr-2" >
                                                        <input
                                                            type="radio"
                                ...
                                <div class="row no-gutters pb-3 d-none" id="chosen_price_div">
                                    <div class="col-sm-2">
                                        <div class="opacity-90 my-2">{{ translate('Total Price')}}:</div>
                                    </div>
                                    <div class="col-sm-10">
                            ...
                            <div class="mt-3">
                                ...
                                @else
                                    ...
                                    <button type="button" class="btn btn-primary buy-now fw-600 mr_10" onclick="buyNow()">
                                        ...
                                        <div class="col-5">
                                            <a href="{{ route('product', $top_product->slug) }}" class="d-block text-reset">
                                                <img
                                                    ...
                                                    src="{{ static_asset('assets/img/placeholder.jpg') }}"
                                                    data-src="{{ uploaded_asset($top_product->photos) }}"
                    ...
                    <div class="bg-white mb-3 shadow-sm rounded">
                        ...
                        <div class="tab-content pt-0">
                            <div class="tab-pane fade active show" id="tab_default_1">
                                <div class="p-4">
                                    <div class="mw-100 overflow-hidden text-left aiz-editor-data" style="font-size: 16px;">
                                        ...
                                        <div class="">
                                            <a href="{{ route('product', $related_product->slug) }}" class="d-block">
                                                <img
                                                    ...
                                                    src="{{ static_asset('assets/img/placeholder.jpg') }}"
                                                    data-src="{{ uploaded_asset($related_product->photos) }}"
                                        ...
                                        <div class="p-md-3 p-2 text-left">
                                            <div class="fs-15">
                                                @if(home_base_price($related_product) != home_discounted_base_price($related_product))
                                                    <del class="fw-600 opacity-90 mr-1">{{ home_base_price($related_product) }}</del>
                                                @endif
                                            ...
                                            <h3 class="fs-13 text-truncate-2 lh-1-4 mb-0 h-35px">
...
@section('script')
    <script type="text/javascript">
        ...
        $('.pic_code_error').hide();
        $('.pic_code_error-1').hide();
        $('#check_pin_code').on('click', function() {
            ...
            if (pin_code) {
                ...
                // $('.pic_code_error').show();
                $('.pic_code_error-1').hide();
                //expexted delivery date start
                $.ajax({
                    type: "post",
                    url: " {{url('delivery_date')}}",
                    data: {
                        pincode: pin_code,
                        unique_id: unique_id,
                        _token: '{{csrf_token()}}'
                    ...
                    console.log(result);
                    $('.pic_code_error').show();
                    $('.pic_code_error').html("<b>Delivery by "+result+"</b>");
                        
                    },
                });
                //expexted delivery date end

            } else {
                $('.pic_code_error-1').show();
                $('.pic_code_error').hide();
            }
        });
