...
<div class="container">
    <div class="row">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="">
                    <img src="public/uploads/all/manufacture_vector.jpg" alt="banner" width="100%;" class="h_450px man_img" loading="lazy">
                </div>
                 <div class="col-xl-12 col-sm-12 col-12">
                    <div class="row">
                        <ul class="col-xl-12 col-sm-12 col-12">
                            <li class="buyer-head fs-20 pr-15px li_brd mb-2"><i class="las la-hand-point-right pr-10px"></i>No hassle of finding a best supplier</li>
                            <li class="buyer-head fs-20 pr-15px li_brd mb-2"><i class="las la-hand-point-right pr-10px"></i>No wait for Quotations</li>
                            <li class="buyer-head fs-20 pr-15px li_brd mb-2"><i class="las la-hand-point-right pr-10px"></i>No negotiations to lapse your valuable time</li>
                            
                        </ul>
                        <ul class="col-xl-12 col-sm-12 col-12">
                            <li class="buyer-head fs-20 pr-15px li_brd mb-2"><i class="las la-hand-point-right pr-10px"></i>Instant & competitive price at your finger tips</li>
                            <li class="buyer-head fs-20 pr-15px li_brd mb-2"><i class="las la-hand-point-right pr-10px"></i>Pay in your local currency</li>
                            <li class="buyer-head fs-20 pr-15px li_brd mb-2"><i class="las la-hand-point-right pr-10px"></i>marketsaltz take care of the delivery at your door step</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="register_title">
                <h4 class="l_g">REGISTER NOW AND START SELLING</h4>
            ...
            <div class="limiter">
                <div class="wrap-login100 tab">
                    <div class="formsection" data-select2-id="21">
                        <form method="post" action="{{url('/next_page')}}" accept-charset="UTF-8" class="login100-form validate-user-form" id="validate_pass" enctype="multipart/form-data">
                            @csrf
    ...
    <div class="register_dashboard_latest">
        <h5>MANUFACTURE REGISTRATION</h5>
    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="wrap-input100 validate-input"
                                        data-validate="Full First Name is required">
                                        <label>
                                            <span class="label_name">Email ID <span id="image2"></span></span>
                                            <input type="hidden" name="back_email" id="back_email"> 
                                ...
                                <div class="col-sm-6">
                                    <div class="wrap-input100 validate-input"
                                        ...
                                        <label><span class="label_name">Password</span>
                                            <input class="input100" placeholder="********" id="password" name="password"
                                                type="password" value="" maxlength="15" aria-autocomplete="list" required>
                                        ...
                                        <span class="help-block blank_password error-password"></span>
                                ...
                                <div class="col-sm-6">
                                    <div class="wrap-input100 validate-input"
                                        ...
                                        <label><span class="label_name">Confirm Password <span id="passimage"></span></span>
                                            <input class="input100 error_clr success_clr" placeholder="********" id="password_confirmation"
                                                name="password_confirmation" type="password" value="" maxlength="" required>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group validate-input" data-select2-id="17">
                                        ...
                                        <select
                                            ...
                                            <option value="" disabled="" selected="" data-select2-id="2">Click to
                                                Select…</option>
                                            ...
                                            @endforeach
                                            <!--<option value="1" data-select2-id="22">I found through Internet search-->
                                            <!--</option>-->
                                            <!--<option value="2" data-select2-id="23">I found through an e-mail /-->
                                            <!--    newsletter</option>-->
                                            <!--<option value="3" data-select2-id="24">Marketsaltz's Marketing Team approached-->
                                            <!--    me</option>-->
                                            <!--<option value="62" data-select2-id="25">ChemExpo 2022</option>-->
                                            <!--<option value="4" data-select2-id="26">A known person referred me to-->
                                            <!--    Marketsaltz</option>-->
                                            <!--<option value="5" data-select2-id="27">I came to know through offline-->
                                            <!--    Advertisement</option>-->
                                            <!--<option value="6" data-select2-id="28">I found it on social media </option>-->
                                            <!--<option value="7" data-select2-id="29">I read about Marketsaltz online</option>-->
                                            <!--<option value="48" data-select2-id="30">I came to know through an Online-->
                                            <!--    Advertisement</option>-->
                                        </select>
      ...
      $.ajax({
          ...
          success:function(response){
               if(response.status==204){
                   ...
                   $('.error-phone').text();
                   $('#phonenumber').prop("vdisabled", true);
       ...
       if(mailotp_val.length==6){
          ...
          success:function(response){
              ...
              if(response.status==205){
                  ...
                  $('#image2').empty().append('<img id="emailverify" src="{{asset("public/assets/verified.png")}}" style="width: 50px;">')
                  $('#emailverify').show();
                  $('#loading-container').hide();
