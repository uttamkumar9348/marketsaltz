                     ...
                     if(this.value.length == 15){
                       ...
                       $.ajax({
                          ...
                          success: function(response){
                            ...
                            $("input[name='district_id']").val(dist).attr("readonly", 'readonly');
        ...
        <div class="col-md-4">
            ...
            <div class="row">
                <ul class="col-xl-12 col-sm-12 col-12">
                    <li class="buyer-head fs-20 pr-15px li_brd mb-2"><i class="las la-hand-point-right pr-10px"></i>Bring your shop to digital front with marketsaltz</li>
                    <li class="buyer-head fs-20 pr-15px li_brd mb-2"><i class="las la-hand-point-right pr-10px"></i>Sell without any hindrance to Domestic & Overseas customers</li>
                    <li class="buyer-head fs-20 pr-15px li_brd mb-2"><i class="las la-hand-point-right pr-10px"></i>Logistics support</li>
                    
                </ul>
                <ul class="col-xl-12 col-sm-12 col-12">
                    <li class="buyer-head fs-20 pr-15px li_brd mb-2"><i class="las la-hand-point-right pr-10px"></i>Sell to any country, marketsaltz pays in your local currency</li>
                    <li class="buyer-head fs-20 pr-15px li_brd mb-2"><i class="las la-hand-point-right pr-10px"></i>Your sale is protected</li>
            ...
            <div class="limiter">
                <div class="wrap-login100 tab">
                    <div class="formsection" data-select2-id="21">
                        <form method="POST" action="{{url('/manufacture_submit')}}" accept-charset="UTF-8" class="login100-form validate-user-form" enctype="multipart/form-data" id="user-register-form" data-select2-id="user-register-form">
                            @csrf
        ...
        <h5>ORGANIZATION REGISTRATION</h5>
               ...
               <div class="form-group validate-input" data-select2-id="17">
                                        <label class="about-carbanio label_name" for="first-choice">Organization Type</label>
                                            <br>
                                        <select class="form-control about select2 input100 select2-hidden-accessible fr_gg" required="" id="country" name="organization_type" data-select2-id="first-choice" tabindex="-1" aria-hidden="true">
                                            
                                            <option value="" disabled="" selected="" data-select2-id="2">Click to Select…</option>
                                            <option value="IN">Indian Registered Company</option>
                                            <option value="OTN">Other than India</option>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="wrap-input100 validate-input" data-validate="Full First Name is required">
                        ...
                        <span class="help-block error-validation error-gst_number"></span>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="wrap-input100 validate-input" data-validate="Password should be min 8 and max 15 characters ">
                        ...
                        <input class="input100 onlytext"  minlength="3" id="district_id" name="district_id" type="text" required>
                        </label>
                          ...
                          <!--                  @endforeach-->
                          <!--              </select>-->
                        <span class="help-block error-validation error-district_id"></span>
                    </div>
                </div>
            </div>
...
$(document).ready( function(){
    ...
    $('#gst-number').focusout( function(){
        if(!$('#gst-number').val()){
            $('.error-gst_number').text("Please Enter Your GTS Number");
        }else{
            $('.error-gst_number').text("");
        }
    });
    // organization name
    $('#Organization-name').focusout( function(){
        if(!$('#Organization-name').val()){
            $('.error-Organization_name').text("Please Enter Your Organization Name");
        }else{
            $('.error-Organization_name').text("");
        }
    });
    ...
    // District Name
    $('#district_id').focusout( function(){
        if(!$('#district_id').val()){
            $('.error-district_id').text("Please Enter Your District Name");
        }else{
