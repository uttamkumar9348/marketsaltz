                        ...
                        <div class="card">
                            ...
                            <div class="px-4 py-3 py-lg-4">
                                    ...
                                    <form id="reg-form" class="form-default" role="form" action="{{ route('register') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group phone-form-group mb-3">
                                                <input type="tel" id="phone-code" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" value="{{ old('phone') }}" placeholder="{{  translate('Phone Number') }}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..?)\../g, '$1');" maxlength="10" name="phone" autocomplete="off">
                                            </div>

                                        @if (addon_is_activated('otp_system'))
                                            <div class="form-group phone-form-group mb-1">
                                                <input type="tel" id="phone-code" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" value="{{ old('phone') }}" placeholder="{{  translate('Phone Number') }}" name="phone" autocomplete="off">
                                            </div>
                                ...
                                <div class="text-center">
                                    <p class="text-muted mb-0 fs_16">{{ translate('Already have an account?')}}</p>
                                    <a href="{{ route('user.login') }}" class="fs_16"><b>{{ translate('Log In')}}</b></a>
                                </div>
                            </div>
                        </div>
                    </div>
