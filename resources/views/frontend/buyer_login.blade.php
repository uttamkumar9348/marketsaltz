...
<div class="container mtb_50">
            ...
            <div class="alert alert-success alert-dismissible fade show col-xl-12" role="alert">
              <strong>{{session::get('confirm')}}</strong> 
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            @endif
    <h1 class="text-center mb_10 f_family">Hello There !</h1>
    <div class="row mt-4">
            ...
            <div class="box_rad1">
                ...
                <h4 class="mb-4 text-center reg_box">Are You New To MarketSaltz ?</h4>
                    ...
                    <div class="text-center">
                        <a href="/buyer_registration" class=" btn btn-outline-warning reg_btn">Register Now</a>
                    </div>
