...
<div class=thankyoucontent>
 <div class="wrapper-1">
    <div class="wrapper-2">
     ...
     <h1>See Details Below!</h1>
     <!--<div class="card">-->
     <!--    <div class="card-body">-->
     <!--        <img src={{$file}} width="200px">-->
     <!--    </div>-->
     <!--</div>-->
      <h4><b>Name :</b><mark>{{$cname}}</mark></h4> 
      <p><b>User mail :</b><mark>{{$pname}}</mark></p>
      <p><b>User mail :</b><mark>{{$dgn_name}}</mark></p>
      <p><b>User mail :</b><mark>{{$email}}</mark></p>
      <p><b>user number :</b>{{$phone_no}}</p>
      <p><b>user number :</b>{{$zip}}</p>
      <p><b>user number :</b>{{$turnover}}</p>
      <p> message :{{$msg}}</p>
      <p> file:{{$file}}</p>
    </div>
