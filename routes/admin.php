...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    //__________AMAN___________//
    
    // Registration Form 
    Route::get('/registration_form', [AdminController::class, 'registration_form']);
    Route::post('/add_registration_option', [AdminController::class, 'add_registration_option']);
    Route::post('/edit_registration_option', [AdminController::class, 'edit_registration_option']);
    Route::get('/delete_registration_option/{id}', [AdminController::class, 'delete_registration_option']);
    
    //END__________AMAN___________//
    ...
    Route::controller(ProductController::class)->group(function () {
        ...
        Route::post('/products/update_product/{product}', 'update_product');
 ...
 //Job post
    Route::get('/career_allpost', [JobController::class, 'jobpost']);
    Route::get('/career_allpost/create', [JobController::class, 'create']);
    Route::post('/insert_job', [JobController::class, 'insert']);
    Route::get('/edit_job/{id}', [JobController::class, 'edit']);
    Route::post('/update_Post/{id}', [JobController::class, 'update_Post']);
    Route::get('/delete_job/{id}', [JobController::class, 'delete_job']);
    Route::post('/qual_fetch', [JobController::class, 'qual_fetch']);
    
    //apply wallet-history
    Route::get('/candidate_list', [JobController::class, 'candidate_list']);
    Route::get('/dlt_candidate/{id}', [JobController::class, 'dlt_candidate']);
    
    //....Buyer .....
    Route::get('/buyer_list', [BuyerController::class, 'buyer_list']);
    Route::get('/dlt_list/{id}', [BuyerController::class, 'dlt_list']);
    
    Route::post('/change_status', [BuyerController::class, 'change_status']);
