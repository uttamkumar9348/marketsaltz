...
// Aman Mukhi //
// Route::get('generate',[HomeController::class,'generate']);
// -------------------------------------------------------------------------- //
...
//payment confirmation page for advertisement
Route::get('/payment_confirmation',[PackageController::class,'payment_confirmation']);


//NEW--bonty--
Route::get('/buyer_registration', [RegistrationController::class, 'registration']);
Route::post('/submit_next', [RegistrationController::class, 'submit_next']);
Route::post('/submit_done', [RegistrationController::class, 'submit_done']);
Route::post('/next_page', [ManufacturerController::class, 'next_page']);
Route::post('/manufacture_submit', [ManufacturerController::class, 'manufacture_submit']);
Route::get('/about', [AboutController::class, 'about']);
Route::get('/contact', [AboutController::class, 'contact_us']);
Route::get('/manufacturer', [ManufacturerController::class, 'manufacturer']);
Route::get('/manufacturer_login', [ManufacturerController::class, 'loginpage']);
Route::get('/manufacturer_register', [ManufacturerController::class, 'register']);
Route::get('/buyer', [BuyerController::class, 'buyer']);
Route::get('/buyer_paymet_protection', [BuyerController::class, 'buyer_protection']);
Route::get('/packages', [BuyerController::class, 'packages']);
Route::get('/buyer_login', [BuyerController::class, 'loginpage']);
Route::get('/machinery', [MachineryController::class, 'machinery'])->name('products.machinery');
Route::post('/machinery_insert', [MachineryController::class, 'insert'])->name('products.insert');
Route::get('/investor_centre', [InvestorController::class, 'create']);
Route::get('/investor_contact', [InvestorController::class, 'investor_contact']);
Route::get('/careers', [CareerController::class, 'create']);
Route::post('/c_apply', [CareerController::class, 'c_apply']);
Route::get('/faqs', [CareerController::class, 'faq']);
Route::get('/mailtest',[CareerController::class,'mailtest']);

Route::post('/packages', [PackageController::class,'Basic_package']);
//GST FETCH----
Route::post('/gst_verify',[BuyerController::class,'gst_verify'])->name('gstverify');
Route::post('/m_gstverify',[BuyerController::class,'m_gstverify'])->name('m_gstverify');

//MAIL--
Route::post('/contact_mail', [CareerController::class, 'contact_mail']);
Route::post('/req_quote', [CareerController::class, 'req_quote']);
//OTP CHECK
Route::post('/phone_otp',[RegistrationController::class,'mobile_otp']);
Route::post('/otp_check',[RegistrationController::class,'otp_check']);
Route::post('/email_otp',[RegistrationController::class,'email_otp']);
Route::post('/mailotp_check',[RegistrationController::class,'mailotp_check']);

Route::post('/check_email',[RegistrationController::class,'check_email']);
...
Route::controller(HomeController::class)->group(function () {
    Route::get('/mail_login', 'mail_login');
...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::post('/machinary_product','m_product');
    ...
    Route::group(['prefix' => 'checkout'], function() {
        Route::controller(CheckoutController::class)->group(function () {
            ...
            Route::post('/remove-club-point', 'remove_club_point')->name('checkout.remove_club_point'); 
                        //uttam(06/02/23)
            Route::post('/billing_addresses', 'store_billing')->name('billing_addresses.store'); 
        });
    });
...
Route::get('/test',[RegistrationController::class,'testotp']);
Route::post('/adsuccesspayment',[PackageController::class,'addsuccesspayment']);

Route::get('/login/google', [App\Http\Controllers\Auth\LoginController::class, 'redirectToGoogle'])->name('login.google');
Route::get('/social-login/google/callback', [App\Http\Controllers\Auth\LoginController::class, 'handleGoogleCallback']);

Route::get('/login/linkedin', [App\Http\Controllers\Auth\LoginController::class, 'redirectToLinkedIn'])->name('login.linkedin');
Route::get('/social-login/linkedin/callback', [App\Http\Controllers\Auth\LoginController::class, 'handleLinkedInCallback']);
...
Route::post('/ip', [App\Http\Controllers\Auth\LoginController::class,'ip']);

//order feedback
Route::get('customer_feedback/{orderid}', [App\Http\Controllers\OrderController::class,'customer_feedback']);
Route::post('customer_feedback_insert', [App\Http\Controllers\OrderController::class,'customer_feedback_inserts']);
Route::get('/thankyou', [App\Http\Controllers\OrderController::class,'thankyou']);

//user feedback
Route::get('customerfeedback/{userid}', [App\Http\Controllers\HomeController::class,'customer_feedback']);
Route::post('feedback_insert', [App\Http\Controllers\HomeController::class,'customer_feedback_inserts']);
Route::get('/thankyou', [App\Http\Controllers\HomeController::class,'thankyou']);

//shiprocket

Route::post('/delivery_date', [App\Http\Controllers\HomeController::class,'delivery_date']);
