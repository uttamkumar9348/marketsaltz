...
class machinery extends Model
{
    ...
    protected $fillable = [
        'name', 'added_by', 'user_id','unique_id','brand_name','model_no','subcategory','hsn_hscode','country_of_origin','product_certification','category_id','tech_parameters', 'brand_id', 'photos', 'thumbnail_img', 'video_provider', 'video_link', 
