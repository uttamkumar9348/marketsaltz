...
class ProductController extends Controller
{
    ...
    public function store(ProductRequest $request)
    {
        ...
        ProductTranslation::create($request->only([
            'lang', 'name', 'unit', 'description', 'product_id', 'cas_no'
        ]));
    ...
    public function update(ProductRequest $request, Product $product)
    {
        ...
        // Update Quantity  and SKU 
        $product_stocks =  ProductStock::where('product_id',$request->id)->first();
        $product_stocks->qty = $request->current_stock;
        $product_stocks->sku = $request->sku;
    ...
    // public function update_1(ProductRequest $request, Product $product)
    // {
    //     dd($request->all());
